// Auto-generated comprehensive drug database
// Generated on 2025-07-20T11:25:23.231Z
// Contains 103 medications
...
export const COMPREHENSIVE_DRUG_DATABASE = {
  "acetaminophen": {
    ...
    "warnings": [
      "Risk of acute liver failure with overdose",
      "Avoid alcohol use",
  ...
  "tramadol": {
    ...
    "warnings": [
      "Seizure risk, especially with doses >400mg/day",
  ...
  "amlodipine": {
    ...
    "interactions": [
      "Simvastatin (increased simvastatin levels)",
      "Sildenafil (hypotension)"
    ],
    "warnings": [
      "May cause hypotension",
      "Increased angina or MI with abrupt withdrawal",
